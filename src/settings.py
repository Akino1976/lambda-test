...
APP_DIRECOTRY = os.path.join(BASE_DIRECTORY, "src")
LOG_CONFIGURATION = os.path.join(BASE_DIRECTORY, "logging_config.yaml")
...
ignored_file_path = os.path.join(BASE_DIRECTORY, ".ignored")
dotenv_path = os.path.join(ignored_file_path, f".{ENVIRONMENT}")
